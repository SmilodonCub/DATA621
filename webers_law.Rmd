...
1. Lu, Z. L., & Dosher, B. (2013). Visual Psychophysics: From laboratory to theory. MIT Press.
2. Palmer, S. E. (1999). Vision science: Photons to phenomenology. MIT press.
3. Barlow, H. B. (1957). Increment thresholds at low intensities considered as signal/noise discriminations. The Journal of Physiology, 136(3), 469-488.
4. Cornsweet, T. N., & Pinsker, H. M. (1965). Luminance discrimination of brief flashes under various conditions of adaptation. The Journal of Physiology, 176(2), 294-310.
5. Laming, D. (2009). Weber’s law. In Insid. Psychol. a Sci. over 50 years. Oxford University Press.
